...
/**
 * @author mesbah
 * @version $Id: StateFlowGraphTest.java 198 2010-01-30 02:45:54Z amesbah $
 */
public class StateFlowGraphTest {
	...
	public void testSFG() throws Exception {
		...
		StateVertix index = new StateVertix("index", "<table><div>index</div></table>", null);
		StateVertix state2 = new StateVertix("STATE_TWO", "<table><div>state2</div></table>", null);
		StateVertix state3 = new StateVertix("STATE_THREE", "<table><div>state3</div></table>", null);
		StateVertix state4 = new StateVertix("STATE_FOUR", "<table><div>state4</div></table>", null);
		StateVertix state5 = new StateVertix("STATE_FIVE", "<table><div>state5</div></table>", null);

		StateFlowGraph graph = new StateFlowGraph(index);

		StateVertix DOUBLE = new StateVertix("index", "<table><div>index</div></table>", null);
		...
		assertTrue(state2.equals(new StateVertix("STATE_2", "<table><div>state2</div></table>", null)));
		...
		StateVertix hold = new StateVertix(index.getName(), index.getDom(), null);
	...
	public void testCloneStates() throws Exception {
		StateVertix index = new StateVertix("index", "<table><div>index</div></table>", null);
		StateVertix state2 = new StateVertix("STATE_TWO", "<table><div>state2</div></table>", null);
		StateVertix state3 = new StateVertix("STATE_THREE", "<table><div>state2</div></table>", null);
	...
	public void testGetMeanStateStringSize() {
		...
		StateFlowGraph g = new StateFlowGraph(new StateVertix("", HTML1, null));
		g.addState(new StateVertix("", HTML2, null));
	...
	public void testDoubleEvents() {
		...
		StateVertix state1 = new StateVertix("STATE_ONE", "<table><div>state1</div></table>", null);
		StateVertix state2 = new StateVertix("STATE_TWO", "<table><div>state2</div></table>", null);
	...
	public void guidedCrawlingFlag() {
		...
		StateVertix state6 = new StateVertix("STATE_FIVE", "<table><div>state5</div></table>", null);
