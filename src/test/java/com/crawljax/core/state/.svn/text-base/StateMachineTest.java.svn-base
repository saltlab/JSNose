 ...
 * @version $Id: StateMachineTest.java 440 2010-09-13 18:28:40Z slenselink@google.com $
 */
public class StateMachineTest {
	private StateMachine sm;
	private final StateVertix index = new StateVertix("index", "<table><div>index</div></table>", null);
	...
	public void testChangeState() {
		StateVertix state2 = new StateVertix("state2", "<table><div>state2</div></table>", null);
	...
	public void testCloneState() {
		...
		StateVertix state2 = new StateVertix("state2", "<table><div>state2</div></table>", null);
		StateVertix state3 = new StateVertix("state3", "<table><div>state2</div></table>", null);
		/**
	...
	public void testRewind() {
		...
		StateVertix state2 = new StateVertix("state2", "<table><div>state2</div></table>", null);
		StateVertix state3 = new StateVertix("state3", "<table><div>state2</div></table>", null);
		StateVertix state4 = new StateVertix("state4", "<table><div>state4</div></table>", null);
		/**
		 * Can not change to state2 because not inserted yet.
		 */
		assertFalse(sm.changeState(state2));
