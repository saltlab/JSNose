...
/**
 * @author mesbah
 * @version $Id: EventableTest.java 265 2010-02-18 17:59:28Z amesbah $
 */
public class EventableTest {
	...
	public void testEdge() {
		...
		StateVertix s1 = new StateVertix("stateSource", "dom1", null);
		StateVertix s2 = new StateVertix("stateTarget", "dom2", null);
