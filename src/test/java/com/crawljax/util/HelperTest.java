...
public class HelperTest {
	...
	public void isLinkExternal() {
		...
		String loc =
		        "_ylt=AlFOMwldcMM2lEfXaNT4nckt17V_/SIG=11ev9v6tg/EXP=1337279137/**http%3A//ca.autos.yahoo.com/";

		assertFalse("* in url", Helper.isLinkExternal("http://ca.yahoo.com", loc));

	}

	public void getBasePathSpecialChar() {
		String loc =
		        "http://ca.yahoo.com/_ylt=AlFOMwldcMM2lEfXaNT4nckt17V_/SIG=11ev9v6tg/EXP=1337279137/**http%3A//ca.autos.yahoo.com/";
